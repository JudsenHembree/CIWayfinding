...
# distCoeffs = np.float32([[k1,k2,p1,p2]])
  ...
  # for marker 1
  ar = ArucoAOI(-0.8, -3.0, 1.5, 1.5, markerLength, "arAOI1")
  arAOI.append(ar)

  # for marker 2
  ar = ArucoAOI(-0.8, -3.0, 1.5, 1.5, markerLength, "arAOI2")
  arAOI.append(ar)

  # for marker 3
  ar = ArucoAOI(-0.8, -3.0, 1.5, 1.5, markerLength, "arAOI3")
  arAOI.append(ar)

  # for marker 4
  ar = ArucoAOI(-0.5, -0.5, 1.0, 1.0, markerLength, "arAOI4")
  arAOI.append(ar)

  # for marker 5
  ar = ArucoAOI(-0.5, -0.5, 1.0, 1.0, markerLength, "arAOI5")
  arAOI.append(ar)

  # for marker 6
  ar = ArucoAOI(-1.9, -2.3, 7.0, 3.5, markerLength, "arAOI6")
  arAOI.append(ar)

  # for marker 7
  ar = ArucoAOI(-0.5, -0.5, 1.0, 1.0, markerLength, "arAOI7")
  arAOI.append(ar)
