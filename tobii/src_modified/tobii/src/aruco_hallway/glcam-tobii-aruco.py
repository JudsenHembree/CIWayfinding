...
# distCoeffs = np.float32([[k1,k2,p1,p2]])
  ...
  # for marker 0
  '''
  ar = ArucoAOI(0.0, 0.0, 10.0, 10.0, markerLength, "arAOI0")
  arAOI.append(ar)

  # for marker 1
  ar = ArucoAOI(0, 0, 10.5, 10.5, markerLength, "arAOI1")
  arAOI.append(ar)

  # for marker 2
  ar = ArucoAOI(-0, 0, 10.5, 10.5, markerLength, "arAOI2")
  arAOI.append(ar)

  # for marker 3
  ar = ArucoAOI(0, 0, 10.5, 10.5, markerLength, "arAOI3")
  arAOI.append(ar)

  # for marker 4
  ar = ArucoAOI(0, 0, 10.0, 10.0, markerLength, "arAOI4")
  arAOI.append(ar)

  # for marker 5
  ar = ArucoAOI(0, 0, 10.0, 10.0, markerLength, "arAOI5")
  arAOI.append(ar)

  # for marker 6
  ar = ArucoAOI(0, 0, 10.0, 10.0, markerLength, "arAOI6")
  arAOI.append(ar)

  # for marker 7
  ar = ArucoAOI(0, 0, 10.0, 10.0, markerLength, "arAOI7")
  arAOI.append(ar)
'''
